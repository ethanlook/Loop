...
final class SettingsTableViewController: UITableViewController, DailyValueScheduleTableViewControllerDelegate, TextFieldTableViewControllerDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case .Services:
            ...
            case .Tidepool:
                let tidepoolService = dataManager.remoteDataManager.tidepoolService
                
                configCell.textLabel?.text = tidepoolService.title
                configCell.detailTextLabel?.text = tidepoolService.username ?? TapToSetString
            }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case .Services:
            ...
            case .Amplitude:
                ...
                showViewController(vc, sender: indexPath)
            case .Tidepool:
                let service = dataManager.remoteDataManager.tidepoolService
                let vc = AuthenticationViewController(authentication: service)
                vc.authenticationObserver = { [unowned self] (service) in
                    self.dataManager.remoteDataManager.tidepoolService = service
